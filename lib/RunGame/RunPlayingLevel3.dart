...
class RunPlayingLevel3 extends StatefulWidget {
  const RunPlayingLevel3({super.key});

  @override
  State<RunPlayingLevel3> createState() => _RunPlayingLevel3State();
}

class _RunPlayingLevel3State extends State<RunPlayingLevel3> {
  Timer? _timer;
  int _remainingSeconds = 120;
  final int _totalMeters = 500;
  String currentscore = "";
  int currentscorenum = 20;
