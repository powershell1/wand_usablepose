...
import 'package:wandquest/RunGame/RunPlayingLevel3.dart';
...
class RunStartLevel3 extends StatefulWidget {
  const RunStartLevel3({super.key});

  @override
  State<RunStartLevel3> createState() => _RunStartLevel3State();
}

class _RunStartLevel3State extends State<RunStartLevel3> {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      if (_countdownNumber > 1) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => RunPlayingLevel3()),
        );
      }
    });
  }
